...
from errors.exceptions import FFmpegError, TranscriptionError, ErrorCode
...
def extract_audio(video_path: str) -> AudioSegment:
    ...
    try:
        cmd = [
            ...
            "-acodec", "pcm_s16le",  # Audio codec: 16-bit little-endian PCM
            "-ar", "16000",    # Audio sample rate: 16kHz (optimal for speech)
        ...
        raise FFmpegError.from_ffmpeg_output(
